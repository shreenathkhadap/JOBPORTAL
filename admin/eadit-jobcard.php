...
">
                                    <p style="font-size: 40px;padding: 15px;">Company Registration</p>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <a href=""><i class="fa fa-home  text-secondary" style="margin-right: 38px;">/
                                                Company</i></a>
                                ...
                                <div class="col-xl-12" style="margin-left: -6px;">
                                    <div class="card">
                                        <div class="px-3 py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h5 class="m-0 font-weight-bold text-dark">Company List</h5>
                                        </div>

                                        <div class="card-body">


                                            <button class="btn btn-dark" type="submit">Copy</button>
                                            <input class="btn btn-dark" type="button" value="Excel">
                                            <input class="btn btn-dark" type="submit" value="CSV">
                                            <input class="btn btn-dark" type="reset" value="PDF">
                                            <input class="btn btn-dark" type="reset" value="Print">
                                            <br>
                                            <br>
                                            <span style="font-size: 20px;padding: 5px 9px 16px 6px;">Show</span>
                                            <select class="form-group col-md-0" aria-label=".form-select-lg example" style="height:11%;">
