    ...
    <div class="row  my-5 login-card shadow">
        <div class="col-md-5 login-card-details">
            ...
            <span style="font-size: smaller;">
                Do not have a account <a href="./company-signup.php">Sign up for free</a>
            </span>
            ...
            <form class="mt-5" action="login_register.php" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        <input type="password" name="password" placeholder="********" class="form-control" name="password" id="password">
                ...
                <button type="submit" name="company_login" class="btn btn-theme-primary w-100 mb-5">Login</button>
            </form>
